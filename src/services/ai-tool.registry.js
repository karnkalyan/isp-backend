...
const tools = [
  ...
  tool("createNas","Create a NAS record and synchronize it to Radius","nas_create","HIGH",true,{ nasIp:{type:"string"}, shortname:{type:"string"}, credentialRef:{type:"string"} }),
  tool("updateNas","Update an existing NAS record and synchronize it to Radius","nas_update","HIGH",true,{ nasIp:{type:"string"}, shortname:{type:"string"}, credentialRef:{type:"string"} }),
  tool("configureMikrotikRadius","Configure an approved Radius server on a MikroTik device","nas_update","HIGH",true,{ routerIp:{type:"string"}, radiusServerIp:{type:"string"}, credentialRef:{type:"string"} }),
